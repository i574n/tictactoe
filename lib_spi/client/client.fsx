...
and closure0 () () : int32 =
    ...
    let v300 : string = "app end"
    let v301 : Types.std.string.String = Fable.Core.Rust.emitExpr v300 v20
    let v302 : Types.EmitType<Types.std.string.String> = v301 |> unbox<Types.EmitType<Types.std.string.String>>
    let v303 : string = "???"
    let v304 : Types.std.string.String = Fable.Core.Rust.emitExpr v303 v20
    let v305 : Types.EmitType<Types.std.string.String> = v304 |> unbox<Types.EmitType<Types.std.string.String>>
    let v306 : (Types.EmitType<Types.std.string.String> []) = [|v302; v305|]
    let v307 : Types.Ref<obj> = Fable.Core.Rust.emitExpr v306 v41
    let v308 : Types.Ref<obj> = Fable.Core.Rust.emitExpr v307 v43
    let v309 : Types.Ref<obj> = Fable.Core.Rust.emitExpr v308 v43
    let v310 : Types.std.string.String = Fable.Core.Rust.emitExpr v309 v23
    let v311 : Types.EmitType<Types.std.string.String> = v310 |> unbox<Types.EmitType<Types.std.string.String>>
    let v312 : Types.chrono.DateTime<Types.chrono.Utc> = Fable.Core.Rust.emitExpr () v4
    let v313 : int64 = Fable.Core.Rust.emitExpr v312 v6
    let v314 : int64 = v313 - v7
    let v315 : string = (v314).ToString ()
    let v316 : int32 = 6
    let v317 : string = method1(v316, v315)
    let v318 : uint8 = Fable.Core.Rust.emitExpr () v54
    let v319 : Types.std.string.String = Fable.Core.Rust.emitExpr v56 v20
    let v320 : Types.EmitType<Types.std.string.String> = v319 |> unbox<Types.EmitType<Types.std.string.String>>
    let v321 : Types.std.string.String = Fable.Core.Rust.emitExpr v317 v20
    let v322 : Types.EmitType<Types.std.string.String> = v321 |> unbox<Types.EmitType<Types.std.string.String>>
    let v323 : Types.std.string.String = Fable.Core.Rust.emitExpr v61 v20
    let v324 : Types.EmitType<Types.std.string.String> = v323 |> unbox<Types.EmitType<Types.std.string.String>>
    let v325 : Types.std.string.String = Fable.Core.Rust.emitExpr v318 v23
    let v326 : Types.EmitType<Types.std.string.String> = v325 |> unbox<Types.EmitType<Types.std.string.String>>
    let v327 : Types.std.string.String = Fable.Core.Rust.emitExpr v66 v20
    let v328 : Types.EmitType<Types.std.string.String> = v327 |> unbox<Types.EmitType<Types.std.string.String>>
    let v329 : Types.std.string.String = Fable.Core.Rust.emitExpr v69 v20
    let v330 : Types.EmitType<Types.std.string.String> = v329 |> unbox<Types.EmitType<Types.std.string.String>>
    let v331 : (Types.EmitType<Types.std.string.String> []) = [|v320; v322; v324; v326; v328; v330|]
    let v332 : Types.Ref<obj> = Fable.Core.Rust.emitExpr v331 v41
    let v333 : Types.Ref<obj> = Fable.Core.Rust.emitExpr v332 v43
    let v334 : Types.Ref<obj> = Fable.Core.Rust.emitExpr v333 v43
    let v335 : Types.std.string.String = Fable.Core.Rust.emitExpr v334 v23
    let v336 : Types.EmitType<Types.std.string.String> = v335 |> unbox<Types.EmitType<Types.std.string.String>>
    let v337 : Types.std.string.String = Fable.Core.Rust.emitExpr v78 v20
    let v338 : Types.EmitType<Types.std.string.String> = v337 |> unbox<Types.EmitType<Types.std.string.String>>
    let v339 : (Types.EmitType<Types.std.string.String> []) = [|v338|]
    let v340 : Types.Ref<obj> = Fable.Core.Rust.emitExpr v339 v41
    let v341 : Types.Ref<obj> = Fable.Core.Rust.emitExpr v340 v43
    let v342 : Types.Ref<obj> = Fable.Core.Rust.emitExpr v341 v43
    let v343 : Types.std.string.String = Fable.Core.Rust.emitExpr v342 v23
    let v344 : Types.EmitType<Types.std.string.String> = v343 |> unbox<Types.EmitType<Types.std.string.String>>
    let v345 : Types.std.string.String = Fable.Core.Rust.emitExpr v344 v87
    let v346 : string = (v345).ToString ()
    let v347 : string = $"r#\"{v90}\"#"
    let v348 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr () v347
    let v349 : Types.regex.RegexBuilder = Fable.Core.Rust.emitExpr v348 v93
    let v350 : Types.Ref<Types.regex.Regex> = Fable.Core.Rust.emitExpr v349 v95
    let v351 : string = method2(v346)
    let v352 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v351 v98
    let v353 : string = method3()
    let v354 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v353 v98
    let v355 : Types.std.string.String = Fable.Core.Rust.emitExpr struct (v350, v352, v354) v102
    let v356 : string = Fable.Core.Rust.emitExpr v355 v104
    let v357 : string = $"r#\"{v106}\"#"
    let v358 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr () v357
    let v359 : Types.regex.RegexBuilder = Fable.Core.Rust.emitExpr v358 v93
    let v360 : Types.Ref<Types.regex.Regex> = Fable.Core.Rust.emitExpr v359 v95
    let v361 : string = method2(v356)
    let v362 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v361 v98
    let v363 : string = method4()
    let v364 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v363 v98
    let v365 : Types.std.string.String = Fable.Core.Rust.emitExpr struct (v360, v362, v364) v102
    let v366 : string = Fable.Core.Rust.emitExpr v365 v104
    let v367 : string = $"r#\"{v117}\"#"
    let v368 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr () v367
    let v369 : Types.regex.RegexBuilder = Fable.Core.Rust.emitExpr v368 v93
    let v370 : Types.Ref<Types.regex.Regex> = Fable.Core.Rust.emitExpr v369 v95
    let v371 : string = method2(v366)
    let v372 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v371 v98
    let v373 : string = method5()
    let v374 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v373 v98
    let v375 : Types.std.string.String = Fable.Core.Rust.emitExpr struct (v370, v372, v374) v102
    let v376 : string = Fable.Core.Rust.emitExpr v375 v104
    let v377 : Types.std.string.String = Fable.Core.Rust.emitExpr v376 v20
    let v378 : Types.EmitType<Types.std.string.String> = v377 |> unbox<Types.EmitType<Types.std.string.String>>
    let v379 : Types.std.string.String = Fable.Core.Rust.emitExpr v311 v87
    let v380 : string = (v379).ToString ()
    let v381 : string = $"r#\"{v90}\"#"
    let v382 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr () v381
    let v383 : Types.regex.RegexBuilder = Fable.Core.Rust.emitExpr v382 v93
    let v384 : Types.Ref<Types.regex.Regex> = Fable.Core.Rust.emitExpr v383 v95
    let v385 : string = method2(v380)
    let v386 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v385 v98
    let v387 : string = method3()
    let v388 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v387 v98
    let v389 : Types.std.string.String = Fable.Core.Rust.emitExpr struct (v384, v386, v388) v102
    let v390 : string = Fable.Core.Rust.emitExpr v389 v104
    let v391 : string = $"r#\"{v106}\"#"
    let v392 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr () v391
    let v393 : Types.regex.RegexBuilder = Fable.Core.Rust.emitExpr v392 v93
    let v394 : Types.Ref<Types.regex.Regex> = Fable.Core.Rust.emitExpr v393 v95
    let v395 : string = method2(v390)
    let v396 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v395 v98
    let v397 : string = method4()
    let v398 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v397 v98
    let v399 : Types.std.string.String = Fable.Core.Rust.emitExpr struct (v394, v396, v398) v102
    let v400 : string = Fable.Core.Rust.emitExpr v399 v104
    let v401 : string = $"r#\"{v117}\"#"
    let v402 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr () v401
    let v403 : Types.regex.RegexBuilder = Fable.Core.Rust.emitExpr v402 v93
    let v404 : Types.Ref<Types.regex.Regex> = Fable.Core.Rust.emitExpr v403 v95
    let v405 : string = method2(v400)
    let v406 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v405 v98
    let v407 : string = method5()
    let v408 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v407 v98
    let v409 : Types.std.string.String = Fable.Core.Rust.emitExpr struct (v404, v406, v408) v102
    let v410 : string = Fable.Core.Rust.emitExpr v409 v104
    let v411 : Types.std.string.String = Fable.Core.Rust.emitExpr v410 v20
    let v412 : Types.EmitType<Types.std.string.String> = v411 |> unbox<Types.EmitType<Types.std.string.String>>
    let v413 : Types.std.string.String = Fable.Core.Rust.emitExpr v336 v87
    let v414 : string = (v413).ToString ()
    let v415 : string = $"r#\"{v90}\"#"
    let v416 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr () v415
    let v417 : Types.regex.RegexBuilder = Fable.Core.Rust.emitExpr v416 v93
    let v418 : Types.Ref<Types.regex.Regex> = Fable.Core.Rust.emitExpr v417 v95
    let v419 : string = method2(v414)
    let v420 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v419 v98
    let v421 : string = method3()
    let v422 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v421 v98
    let v423 : Types.std.string.String = Fable.Core.Rust.emitExpr struct (v418, v420, v422) v102
    let v424 : string = Fable.Core.Rust.emitExpr v423 v104
    let v425 : string = $"r#\"{v106}\"#"
    let v426 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr () v425
    let v427 : Types.regex.RegexBuilder = Fable.Core.Rust.emitExpr v426 v93
    let v428 : Types.Ref<Types.regex.Regex> = Fable.Core.Rust.emitExpr v427 v95
    let v429 : string = method2(v424)
    let v430 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v429 v98
    let v431 : string = method4()
    let v432 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v431 v98
    let v433 : Types.std.string.String = Fable.Core.Rust.emitExpr struct (v428, v430, v432) v102
    let v434 : string = Fable.Core.Rust.emitExpr v433 v104
    let v435 : string = $"r#\"{v117}\"#"
    let v436 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr () v435
    let v437 : Types.regex.RegexBuilder = Fable.Core.Rust.emitExpr v436 v93
    let v438 : Types.Ref<Types.regex.Regex> = Fable.Core.Rust.emitExpr v437 v95
    let v439 : string = method2(v434)
    let v440 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v439 v98
    let v441 : string = method5()
    let v442 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v441 v98
    let v443 : Types.std.string.String = Fable.Core.Rust.emitExpr struct (v438, v440, v442) v102
    let v444 : string = Fable.Core.Rust.emitExpr v443 v104
    let v445 : Types.std.string.String = Fable.Core.Rust.emitExpr v444 v20
    let v446 : Types.EmitType<Types.std.string.String> = v445 |> unbox<Types.EmitType<Types.std.string.String>>
    let v447 : bool = Fable.Core.Rust.emitExpr () v198
    let v450 : US0 =
        if v447 then
            US0_1
        else
    ...
    match v450 with
    | US0_1 -> (* Wasm32 *)
        let v451 : string = (v378).ToString ()
        let v452 : string = (v412).ToString ()
        let v453 : string = (v446).ToString ()
        let v454 : string = " %c"
        let v455 : string = v451 + v454
        let v456 : string = v455 + v452
        let v457 : string = v456 + v454
        let v458 : string = v457 + v453
        let v459 : string = "($0).as_ref().to_string()"
        let v460 : Types.std.string.String = Fable.Core.Rust.emitExpr v458 v459
        let v461 : string = "387957"
        let v462 : string = $"color: #{v461};"
        let v463 : Types.std.string.String = Fable.Core.Rust.emitExpr v462 v459
        let v464 : string = "color: #385779;"
        let v465 : Types.std.string.String = Fable.Core.Rust.emitExpr v464 v459
        let v466 : (Types.std.string.String []) = [|v460; v463; v465|]
        let v467 : Types.Ref<Types.Vec<obj>> = Fable.Core.Rust.emitExpr v466 v41
        let v468 : obj = v467
        let v469 : string = "serde_wasm_bindgen::to_value(&*****$0).unwrap()"
        let v470 : obj = Fable.Core.Rust.emitExpr v468 v469
        let v471 : string = "web_sys::console::log(&js_sys::Array::from(&$0))"
        Fable.Core.Rust.emitExpr v470 v471
        ()
    | _ ->
        let v472 : string = method6()
        let v473 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v472 v98
        let v474 : unativeint = unativeint 0
        let v475 : unativeint = unativeint 2
        let v476 : string = "&$0[$1..$2]"
        let v477 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr struct (v473, v474, v475) v476
        let v478 : string = Fable.Core.Rust.emitExpr v477 v104
        let v479 : string = "u8::from_str_radix($0, 16).unwrap()"
        let v480 : uint8 = Fable.Core.Rust.emitExpr v478 v479
        let v481 : string = method6()
        let v482 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v481 v98
        let v483 : unativeint = unativeint 2
        let v484 : unativeint = unativeint 4
        let v485 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr struct (v482, v483, v484) v476
        let v486 : string = Fable.Core.Rust.emitExpr v485 v104
        let v487 : uint8 = Fable.Core.Rust.emitExpr v486 v479
        let v488 : string = method6()
        let v489 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v488 v98
        let v490 : unativeint = unativeint 4
        let v491 : unativeint = unativeint 6
        let v492 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr struct (v489, v490, v491) v476
        let v493 : string = Fable.Core.Rust.emitExpr v492 v104
        let v494 : uint8 = Fable.Core.Rust.emitExpr v493 v479
        let v495 : string = "colored::Colorize::truecolor(&*$0.to_string(), $1, $2, $3)"
        let v496 : Types.colored.ColoredString = Fable.Core.Rust.emitExpr struct (v412, v480, v487, v494) v495
        let v497 : Types.std.string.String = Fable.Core.Rust.emitExpr v496 v87
        let v498 : string = method7()
        let v499 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v498 v98
        let v500 : unativeint = unativeint 0
        let v501 : unativeint = unativeint 2
        let v502 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr struct (v499, v500, v501) v476
        let v503 : string = Fable.Core.Rust.emitExpr v502 v104
        let v504 : uint8 = Fable.Core.Rust.emitExpr v503 v479
        let v505 : string = method7()
        let v506 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v505 v98
        let v507 : unativeint = unativeint 2
        let v508 : unativeint = unativeint 4
        let v509 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr struct (v506, v507, v508) v476
        let v510 : string = Fable.Core.Rust.emitExpr v509 v104
        let v511 : uint8 = Fable.Core.Rust.emitExpr v510 v479
        let v512 : string = method7()
        let v513 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr v512 v98
        let v514 : unativeint = unativeint 4
        let v515 : unativeint = unativeint 6
        let v516 : Types.Ref<Types.Str> = Fable.Core.Rust.emitExpr struct (v513, v514, v515) v476
        let v517 : string = Fable.Core.Rust.emitExpr v516 v104
        let v518 : uint8 = Fable.Core.Rust.emitExpr v517 v479
        let v519 : Types.colored.ColoredString = Fable.Core.Rust.emitExpr struct (v446, v504, v511, v518) v495
        let v520 : Types.std.string.String = Fable.Core.Rust.emitExpr v519 v87
        let v521 : string = $"{v378} {v497} {v520}"
        System.Console.WriteLine v521
        ()
    0
