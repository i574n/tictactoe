...
pub mod Supervisor {
    ...
    pub fn method6(v0_1: string) -> string { v0_1 }
    pub fn method7() -> string { string("$1=$2") }
    pub fn method8() -> string { string("[$1]") }
    pub fn method9() -> string { string("\"") }
    pub fn method10() -> string { string(" ") }
    pub fn method11() -> string { string("de884c") }
    pub fn method12() -> string { string("385779") }
    pub fn method2(v0_1: i64, v1: Array<std::string::String>) {
        let v3: chrono::DateTime<chrono::Utc> = chrono::Utc::now();
        let v9: string =
            Supervisor::method3(6i32, toString(&((&v3).timestamp() - v0_1)));
        let v11: u8 = rand::random::<u8>();
        let v23: std::string::String =
            Supervisor::method5(array(&[Supervisor::method1(string("timestamp")),
        ...
        if let Supervisor::US0::US0_1 =
               &if cfg!(target_arch = "wasm32") {
                    Supervisor::US0::US0_1
                } else { Supervisor::US0::US0_0 } {
            ...
            let v199: Array<std::string::String> =
                array(&[(&v191).as_ref().to_string(),
                        (&stringFrom(format!("color: #{0};",
                                             &string("de884c")))).as_ref().to_string(),
    ...
    pub fn method15() -> string { string("e36a62") }
    pub fn method14(v0_1: i64, v1: Array<std::string::String>) {
        ...
        if let Supervisor::US0::US0_1 =
            ...
            let v199: Array<std::string::String> =
                array(&[(&v191).as_ref().to_string(),
                        (&stringFrom(format!("color: #{0};",
                                             &string("e36a62")))).as_ref().to_string(),
                        (&string("color: #385779;")).as_ref().to_string()]);
            let v200 = core::ops::Deref::deref(&v199);
            let v203 = serde_wasm_bindgen::to_value(&*****&v200).unwrap();
            web_sys::console::log(&js_sys::Array::from(&v203));
    ...
    pub fn method17() -> string { string("fcfb1b") }
    pub fn method16(v0_1: i64, v1: Array<std::string::String>) {
        ...
        if let Supervisor::US0::US0_1 =
            ...
            let v199: Array<std::string::String> =
                array(&[(&v191).as_ref().to_string(),
                        (&stringFrom(format!("color: #{0};",
                                             &string("fcfb1b")))).as_ref().to_string(),
                        (&string("color: #385779;")).as_ref().to_string()]);
            let v200 = core::ops::Deref::deref(&v199);
            let v203 = serde_wasm_bindgen::to_value(&*****&v200).unwrap();
            web_sys::console::log(&js_sys::Array::from(&v203));
    ...
    pub fn method19() -> string { string("98d5ef") }
    pub fn method18(v0_1: i64, v1: Array<std::string::String>) {
        ...
        if let Supervisor::US0::US0_1 =
            ...
            let v199: Array<std::string::String> =
                array(&[(&v191).as_ref().to_string(),
                        (&stringFrom(format!("color: #{0};",
                                             &string("98d5ef")))).as_ref().to_string(),
                        (&string("color: #385779;")).as_ref().to_string()]);
            let v200 = core::ops::Deref::deref(&v199);
            let v203 = serde_wasm_bindgen::to_value(&*****&v200).unwrap();
            web_sys::console::log(&js_sys::Array::from(&v203));
    ...
    pub fn method22() -> string { string("387957") }
    ...
    pub fn closure1(v0_1: std::path::PathBuf, v1: Option<std::path::PathBuf>)
     -> string {
        ...
        let v21: std::string::String =
            Supervisor::method1(fable_library_rust::String_::fromStr(&format!("{}", &v18.display())));
        let v22: string = string("spi_path");
        let v23: std::string::String = Supervisor::method1(v22.clone());
        let v25: std::string::String =
            Supervisor::method1(fable_library_rust::String_::fromStr(&format!("{}", &v0_1.display())));
        let v27: std::string::String =
            Supervisor::method1(string("new_fsx_path"));
        let v28: std::path::PathBuf = (&v1).as_ref().unwrap().to_path_buf();
        Supervisor::method2(v9,
                            array(&[v11, v21, v23, v25, v27,
                                    Supervisor::method1(fable_library_rust::String_::fromStr(&format!("{}", &v28.display())))]));
        {
            let v32: Result<std::path::PathBuf, std::io::Error> =
                (&v0_1).canonicalize();
            let v33: std::path::PathBuf =
                (&v32).as_ref().unwrap().to_path_buf();
            Supervisor::method2(v9,
                                array(&[Supervisor::method1(string("spi_path_clean")),
                                        Supervisor::method1(fable_library_rust::String_::fromStr(&format!("{}", &v33.display())))]));
            {
                ...
                let v45: Result<std::path::PathBuf, std::io::Error> =
                    (&v44).canonicalize();
                let v46: std::path::PathBuf =
                    (&v45).as_ref().unwrap().to_path_buf();
                Supervisor::method2(v9,
                                    array(&[Supervisor::method1(string("src_path")),
                                            Supervisor::method1(fable_library_rust::String_::fromStr(&format!("{}", &v46.display())))]));
                {
                    ...
                    let v64: Option<std::path::PathBuf> =
                        v60.into_iter().find((&v61).clone());
                    let v65: std::path::PathBuf =
                        (&v64).as_ref().unwrap().to_path_buf();
                    let v66: string = string("spiproj_path");
                    Supervisor::method2(v9,
                                        array(&[Supervisor::method1(v66.clone()),
                                                Supervisor::method1(fable_library_rust::String_::fromStr(&format!("{}", &v65.display())))]));
                    {
                        let v72: Option<&str> = (&v33).to_str();
                        let v73: &str = &v72.unwrap();
                        let v76: string = string(".spi");
                        let v79: &str =
                            &v73.replace(&*(&string(".spir")).clone(), &(&v76).clone());
                        let v83: &str =
                            &v79.replace(&*(&v76).clone(), &(&string(".fsx")).clone());
                        let v84: std::path::PathBuf =
                            std::path::PathBuf::from(&v83);
                        let v85: Result<std::path::PathBuf, std::io::Error> =
                            (&v84).canonicalize();
                        let v86: std::path::PathBuf =
                            (&v85).as_ref().unwrap().to_path_buf();
                        let v87: string = string("fsx_path");
                        Supervisor::method2(v9,
                                            array(&[Supervisor::method1(v87.clone()),
                                                    Supervisor::method1(fable_library_rust::String_::fromStr(&format!("{}", &v86.display())))]));
                        {
                            ...
                            *((&v94).as_ref()).unwrap();
                            Supervisor::method2(v9,
                                                array(&[Supervisor::method1(string("> fs_write fsx_path \"\"; ok"))]));
                            {
                                let v100:
                                ...
                                let patternInput_1:
                                    ...
                                    Supervisor::method0();
                                let v107: chrono::DateTime<chrono::Utc> =
                                    chrono::Utc::now();
                                let v108: i64 = (&v107).timestamp();
                                Supervisor::method14(v108,
                                                     array(&[Supervisor::method1(v66),
                                                             Supervisor::method1(fable_library_rust::String_::fromStr(&format!("{}", &v65.display()))),
                                                             ...
                                                             Supervisor::method13((&v102).len().try_into().unwrap())]));
                                {
                                    ...
                                    let v130: string =
                                        string(").to_string()");
                                    let v131: string =
                                        append(append(v128.clone(),
                                                      append(append(append(append(append(v118.clone(),
                                    ...
                                    Supervisor::method14(v108,
                                                         array(&[Supervisor::method1(string("json len=")),
                                                                 Supervisor::method13((&v132).len().try_into().unwrap())]));
                                    {
                                        ...
                                        Supervisor::method16(v143,
                                                             array(&[Supervisor::method1(v144.clone()),
                                            ...
                                            v160.send(v132.as_str(), 0).unwrap();
                                            {
                                                ...
                                                v160.disconnect(&v161).unwrap();
                                                {
                                                    let v167: string =
                                                        string("result len");
                                                    Supervisor::method16(v143,
                                                                         array(&[Supervisor::method1(v167.clone()),
                                                                                 Supervisor::method13((&v165).len().try_into().unwrap())]));
                                                    Supervisor::method2(v9,
                                                                        array(&[Supervisor::method1(string("> spiproj_open; ok"))]));
                                                    {
                                                        let patternInput_3:
                                                                (string,
                                                                 string,
                                                                                     ...
                                                                                     Supervisor::method1(v186.clone())]));
                                                        {
                                                            ...
                                                            Supervisor::method18(v180,
                                                                                 array(&[Supervisor::method1(string("json len")),
                                                                                         Supervisor::method13((&v200).len().try_into().unwrap())]));
                                                            {
                                                                let patternInput_4:
                                                                        (string,
                                                                         string,
                                                                                             ...
                                                                                             Supervisor::method13((&v200).len().try_into().unwrap())]));
                                                                {
                                                                    ...
                                                                    let v223:
                                                                        ...
                                                                        stringFrom(format!("tcp://{0}:{1}",
                                                                                           &v146,
                                                                                           &13805i32));
                                                                    v222.connect(&v223.clone()).unwrap();
                                                                    v222.send(v200.as_str(), 0).unwrap();
                                                                    {
                                                                        let v225:
                                                                                std::string::String =
                                                                            v222.recv_string(0).unwrap().unwrap();
                                                                        v222.disconnect(&v223).unwrap();
                                                                        Supervisor::method16(v211,
