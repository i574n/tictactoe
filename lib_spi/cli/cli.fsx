...
and method5 (v0 : int64, v1 : (Types.EmitType<Types.std.string.String> [])) : unit =
    ...
    let v87 : Types.EmitType<Types.std.string.String> = method3(v86)
    ...
    let v135 : Types.EmitType<Types.std.string.String> = method3(v134)
    ...
    let v178 : Types.EmitType<Types.std.string.String> = method3(v177)
...
and closure1 (v0 : int64, v1 : Mut0) (v2 : Types.Vec<uint8>) : Result<bool, Types.std.io.Error> =
    ...
    method20(v0, v8)
    let v9 : string = "std::string::String::from_utf8(($0).to_owned()).unwrap()"
    let v10 : Types.std.string.String = Fable.Core.Rust.emitExpr v2 v9
    let v11 : UH0 = v1.l0
    let v12 : UH0 = UH0_0(v10, v11)
    v1.l0 <- v12
    let v13 : Result<bool, Types.std.io.Error> = Ok true
    v13
...
and method24 (v0 : int64, v1 : UH1, v2 : int32, v3 : UH1) : struct (int32 * UH1) =
    ...
    | UH1_0(v4, v5) -> (* Cons *)
        ...
        let struct (v25 : int32, v26 : UH1) =
            if v10 then
                let v11 : string = "found line. removing."
                let v12 : Types.EmitType<Types.std.string.String> = method3(v11)
                let v13 : string = " line"
                let v14 : Types.EmitType<Types.std.string.String> = method3(v13)
                let v15 : Types.EmitType<Types.std.string.String> = method3(v4)
                let v16 : (Types.EmitType<Types.std.string.String> []) = [|v12; v14; v15|]
                method5(v0, v16)
                struct (1, v3)
            else
                let v17 : bool = 0 = v2
                if v17 then
                    let v18 : UH1 = UH1_0(v4, v3)
                    struct (0, v18)
                else
                    let v19 : bool = 2 = v2
                    if v19 then
