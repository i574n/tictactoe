...
module Main =
    let minimumLogLevel = LogLevel.Debug // Information
    ...
    type Arguments =
        ...
        interface IArgParserTemplate with
            member this.Usage =
                match this with
                | Root_Path _ ->
                    "Where data will be stored in the format of !alias/!soul/!collection/!ticksGuid/!atomName."
