...
from typing import (Any, List, Literal, Tuple, Callable)
...
def method0(__unit: Literal[None]=None) -> Tuple[str, str, str, str, str, str, str, str, str]:
...
def closure0(unit_var: None, v0_1: US0) -> bool:
    ...
    v31: Array[bool] = [pyteal.Return(v29)]
    ...
    v79: Array[bool] = [v40, v45, v51, v56, v61, v64, v67, v70, v73, v76, pyteal.Return(v77)]
    ...
    v86: Array[bool] = [v9_1, pyteal.Seq([v26, v28, v84])]
    ...
    v159: Array[bool] = [v115, v156, pyteal.App.globalPut(v100, v157)]
    ...
    v206: Array[bool] = [v162, v203, pyteal.App.globalPut(v100, v204)]
    ...
    v236: Array[bool] = [(pyteal.Txn.sender()) == (pyteal.App.globalGet(v101)), v160]
    v240: Array[bool] = [(pyteal.Txn.sender()) == (pyteal.App.globalGet(v98)), v207]
    ...
    v262: Array[bool] = [v210, v213, v217, v220, v224, v232, v241, v259, pyteal.Return(v260)]
    v264: Array[bool] = [v92, pyteal.Seq(v262)]
    ...
    v305: Array[bool] = [v295, v302, pyteal.App.globalPut(v271, v303)]
    ...
    v335: Array[bool] = [v325, v332, pyteal.App.globalPut(v271, v333)]
    ...
    v370: Array[bool] = [v344, v349, v354, v359, v364, pyteal.Assert(v368)]
    ...
    v382: Array[bool] = [v290, v306]
    v383: Array[bool] = [v320, v336]
    v384: Array[bool] = [v339, v371]
    v385: bool = pyteal.Cond(v382, v383, v384)
    v386: int = (pyteal.Int(1)) or 0
    v388: Array[bool] = [v376, v381, v385, pyteal.Return(v386)]
    v390: Array[bool] = [v266, pyteal.Seq(v388)]
    ...
    v413: Array[bool] = [v407, v408, v409, v410, pyteal.Return(v411)]
...
def closure1(unit_var: None, unit_var_1: None) -> bool:
    ...
    v21: Array[bool] = [v15, v16, v17, v18, pyteal.Return(v19)]
    return pyteal.Seq(v21)


def closure2(unit_var: None, v0_1: US0) -> bool:
    to_console(interpolate("%A%P()", ["initialize_players_logic"]))
    pattern_input: Tuple[str, str, str, str, str, str, str, str, str] = method0()
    ...
    v20: int = (pyteal.Int(0)) or 0
    v22: Array[bool] = [pyteal.Return(v20)]
    ...
    v70: Array[bool] = [v31, v36, v42, v47, v52, v55, v58, v61, v64, v67, pyteal.Return(v68)]
...
def closure3(unit_var: None, unit_var_1: None) -> bool:
    to_console(interpolate("%A%P()", ["play_action_logic"]))
    pattern_input: Tuple[str, str, str, str, str, str, str, str, str] = method0()
    ...
    v66: Array[bool] = [v22, v63, pyteal.App.globalPut(v7_1, v64)]
    ...
    v113: Array[bool] = [v69, v110, pyteal.App.globalPut(v7_1, v111)]
    ...
    v143: Array[bool] = [(pyteal.Txn.sender()) == (pyteal.App.globalGet(v8_1)), v67]
    v147: Array[bool] = [(pyteal.Txn.sender()) == (pyteal.App.globalGet(v5_1)), v114]
    ...
    v169: Array[bool] = [v117, v120, v124, v127, v131, v139, v148, v166, pyteal.Return(v167)]
    return pyteal.Seq(v169)


def closure4(unit_var: None, unit_var_1: None) -> bool:
    to_console(interpolate("%A%P()", ["is_tie"]))
    pattern_input: Tuple[str, str, str, str, str, str, str, str, str] = method0()
...
def closure5(unit_var: None, v0_1: int) -> bool:
    to_console(interpolate("%A%P()", ["has_player_won"]))
...
def closure6(unit_var: None, v0_1: int) -> bool:
    ...
    v22: Array[bool] = [v6_1, v11, v16, pyteal.Assert(v20)]
    v23: bool = pyteal.Seq(v22)
    ...
    v59: Array[bool] = [v28, v33, v38, v43, v48, v53, pyteal.Assert(v57)]
    v60: bool = pyteal.Seq(v59)
    v64: Array[bool] = [(pyteal.Global.group_size()) == (pyteal.Int(2)), v23]
    v68: Array[bool] = [(pyteal.Global.group_size()) == (pyteal.Int(3)), v60]
    v69: bool = pyteal.Cond(v64, v68)
    v70: int = (pyteal.Int(1)) or 0
    v72: Array[bool] = [v69, pyteal.Return(v70)]
    return pyteal.Seq(v72)


def closure7(unit_var: None, unit_var_1: None) -> bool:
    to_console(interpolate("%A%P()", ["money_refund_logic"]))
    pattern_input: Tuple[str, str, str, str, str, str, str, str, str] = method0()
    v8_1: str = pattern_input[7]
    v7_1: str = pattern_input[6]
    ...
    v38: Array[bool] = [v28, v35, pyteal.App.globalPut(v4_1, v36)]
    ...
    v68: Array[bool] = [v58, v65, pyteal.App.globalPut(v4_1, v66)]
    ...
    v103: Array[bool] = [v77, v82, v87, v92, v97, pyteal.Assert(v101)]
    ...
    v115: Array[bool] = [v23, v39]
    v116: Array[bool] = [v53, v69]
    v117: Array[bool] = [v72, v104]
    v118: bool = pyteal.Cond(v115, v116, v117)
    v119: int = (pyteal.Int(1)) or 0
    v121: Array[bool] = [v109, v114, v118, pyteal.Return(v119)]
    return pyteal.Seq(v121)


def closure8(unit_var: None, unit_var_1: None) -> bool:
...
def _arrow1(v: US0) -> bool:
    return closure0(None, v)


v1: Callable[[US0], bool] = _arrow1

def _arrow2(__unit: Literal[None]=None) -> bool:
    return closure1(None, None)


v2: Callable[[], bool] = _arrow2

def _arrow3(v: US0) -> bool:
    return closure2(None, v)


v3: Callable[[US0], bool] = _arrow3

def _arrow4(__unit: Literal[None]=None) -> bool:
    return closure3(None, None)


v4: Callable[[], bool] = _arrow4

def _arrow5(__unit: Literal[None]=None) -> bool:
    return closure4(None, None)


v5: Callable[[], bool] = _arrow5

def _arrow6(v: int) -> bool:
    return closure5(None, v)


v6: Callable[[int], bool] = _arrow6

def _arrow7(v: int) -> bool:
    return closure6(None, v)


v7: Callable[[int], bool] = _arrow7

def _arrow8(__unit: Literal[None]=None) -> bool:
    return closure7(None, None)


v8: Callable[[], bool] = _arrow8

def _arrow9(__unit: Literal[None]=None) -> bool:
    return closure8(None, None)


v9: Callable[[], bool] = _arrow9
