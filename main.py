...
def closure5(unit_var0: None, v0_1: US0) -> bool:
    to_console(interpolate("%A%P()", ["initialize_players_logic"]))
    pattern_input : Tuple[str, str, str, str, str, str, str, str, str] = method0()
    v9 : str = pattern_input[7]
    ...
    v17 : int = (pyteal.App.globalGetEx(v16, v9)) or 0
    ...
    v55 : bool = pyteal.App.globalPut(v9, v54)
...
def closure6(unit_var0: None, v0_1: US0) -> bool:
    ...
    v9 : bool = pyteal.Txn.application_args[0] == v2_1
    to_console(interpolate("%A%P()", ["initialize_players_logic"]))
    pattern_input : Tuple[str, str, str, str, str, str, str, str, str] = method0()
    ...
    v86 : List[bool] = [v9, pyteal.Seq([v26, v28, v84])]
...
def arrow_3(v0_1: int) -> bool:
    return closure2(None, v0_1)


v3 : Callable[[int], bool] = arrow_3
...
def arrow_6(v0_1: US0) -> bool:
    return closure5(None, v0_1)


v6 : Callable[[US0], bool] = arrow_6

def arrow_7(v0_1: US0) -> bool:
    return closure6(None, v0_1)


v7 : Callable[[US0], bool] = arrow_7

def arrow_8(v0_1: int) -> bool:
    return closure7(None, v0_1)


v8 : Callable[[int], bool] = arrow_8
