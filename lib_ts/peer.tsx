...
export function Mut0$reflection(): TypeInfo {
    return record_type("Peer.Mut0", [], Mut0, () => [["l0", obj_type]]);
}
...
export function UH1$reflection(): TypeInfo {
    return union_type("Peer.UH1", [], UH1_Cons, () => [[], [["Item", US0$reflection()]], [["Item1", string_type], ["Item2", string_type], ["Item3", US0$reflection()]], [["Item", array_type(string_type)]], [["Item1", string_type], ["Item2", string_type], ["Item3", array_type(string_type)], ["Item4", array_type(string_type)]], [["Item", bool_type]]]);
}
